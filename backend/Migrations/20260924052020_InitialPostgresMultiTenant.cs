...
{
    /// <inheritdoc />
    public partial class InitialPostgresMultiTenant : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoublePrice = table.Column<decimal>(type: "numeric", nullable: true),
                    ThirdPrice = table.Column<decimal>(type: "numeric", nullable: true),
                    PricingScheme = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseAttachments_Purchases_PurchaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseAttachments_PurchaseId",
