...
namespace PosApi.Migrations
{
    ...
    [Migration("20260926131323_AddItemPacks")]
    partial class AddItemPacks
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StockCount", b =>
                {
                    ...
                    b.HasIndex("RestaurantId", "Date", "ItemId")
                        .IsUnique();

                    b.ToTable("StockCounts");
                });

            modelBuilder.Entity("StockUsage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
